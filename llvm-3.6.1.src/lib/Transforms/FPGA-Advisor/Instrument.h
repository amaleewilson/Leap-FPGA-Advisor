...
#ifndef LLVM_LIB_TRANSFORMS_FINSTRUMENT_H
#define LLVM_LIB_TRANSFORMS_FINSTRUMENT_H
...
static RegisterPass<FInstrument> X("finstrument", "FPGA-Advisor Instrumentation Pass", false, false);
